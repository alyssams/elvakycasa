(function ($) {
	...
	if (!Modernizr.touch) {
	    ...
	    pinScene01Tl
	    	// .from($("#slide01 .wrapper"),2,{right:400},1)
			.from($("#slide01 .wrapper"),2,{left:'50%'},1)
	    	.to($('#slide01 h1'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    	.to($('#slide01 section'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    	.set($('#slide01 h3'), {text: 'New & Classic'})
	    	.set($('#slide01 h1'), {text: 'TV Shows'})
	    	.set($('#slide01 p'), {text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit-hasellus condimentum ligula."})
	    	...
	    	// .to($('#slide01 h1'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    	// .to($('#slide01 section'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    	// .set($('#slide01 h3'), {text: 'Exciting'})
	    	// .set($('#slide01 h1'), {text: 'Sports & News'})
	    	// .set($('#slide01 p'), {text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit-hasellus condimentum ligula."})
	    	// .fromTo($('#slide01 h1'), 0.7, {y: '+=20'}, {y: 0, autoAlpha: 1, ease:Power1.easeOut}, '+=0.4')
	    	// .fromTo($('#slide01 section'), 0.6, {y: '+=20'}, {y: 0, autoAlpha: 1, ease:Power1.easeOut}, '-=0.6')
	    	// .set($('#slide01 h1'), {autoAlpha: 1}, '+=2');
	    ...
	    // SCENE 6.2 - pin the first section
	    // and update text

	    // var pinScene012Tl = new TimelineMax();

	    // pinScene012Tl
	    // 	.to($('#slide01 h1'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    // 	.to($('#slide01 section'), 0.2, {autoAlpha: 0, ease:Power1.easeNone}, 1.5)
	    // 	.set($('#slide01 h3'), {text: 'Exclusive'})
	    // 	.set($('#slide01 h1'), {text: 'Premium Channels'})
